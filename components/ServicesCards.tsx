  ...
  const services = [
    {
      ...
      // Save your image as /public/private-events.jpg
      // and it will be served from this path.
      imageUrl: '/IMG-20251126-WA0016.jpg',
      icon: (
    ...
    },
    {
      ...
      // Image stored in /public/IMG-20251126-WA0032.jpg
      imageUrl: '/IMG-20251126-WA0032.jpg',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      // Image stored in /public/IMG-20251126-WA0038.jpg
      imageUrl: '/IMG-20251126-WA0038.jpg',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
        ...
        <div className="grid md:grid-cols-3 gap-8 md:gap-6 lg:gap-8">
          {services.map((service, index) => (
            ...
            >
              {/* Image Section */}
              <div
                className={`relative h-64 flex items-center justify-center ${service.imageUrl ? '' : service.imageBg}`}
                style={
                  // If an imageUrl is provided, use it as a background image
                  service.imageUrl
                    ? {
              ...
              >
                {/* For cards without a custom image, show the emoji */}
                {!service.imageUrl && <div className="text-8xl opacity-80">{service.imageEmoji}</div>}
